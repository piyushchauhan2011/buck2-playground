...
#
# With those in place, buck2 cquery has a full view of the repository's
...
# ── Enumerate owning targets via cquery ───────────────────────────────────────
OWNING=""
...
ALL_IMPACTED=$(buck2 cquery "rdeps(//..., $TARGETS_SET)" 2>/dev/null \
